...
The hybrid algorithm was implemented in Python (\texttt{\detokenize{simulate_allocation.py}}) and tested on a system with an Intel i7-12700H CPU (14 cores, 2.3--4.7~GHz), 
